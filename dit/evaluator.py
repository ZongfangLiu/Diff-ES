...
INCEPTION_V3_PATH = os.path.join("pretrained_models", "classify_image_graph_def.pb")
...
def main():
    ...
    help="If set, write metrics as JSON here (e.g., experiments/<exp>/eval/metrics.json)")
    parser.add_argument("--out-text", type=str, default=None,
    help="If set, write a human-readable text file here (e.g., experiments/<exp>/eval/metrics.txt)")
    ...
    print("Inception Score:", results["inception_score"])
    print("FID:", results["fid"])
    print("sFID:", results["sfid"])
